...
public class DurablePayloadReplayTests
{
    ...
    public void AV8OrchestrationInput_ReplaysByteForByte()
    {
        ...
        var withRefs = stored
            .Replace("\"InputFiles\":null}", "\"InputFiles\":null,\"InputRefs\":null,\"InputFormRefs\":null,\"MacroChoices\":null,\"TranscriptInputs\":null,\"AmbientNoteInputs\":null,\"AcknowledgedShortInputs\":null}", StringComparison.Ordinal)
    ...
    public void AStoredRequest_WithoutMacroChoices_BindsNull()
    {
        ...
        // null. #671 appended TranscriptInputs, #673 AmbientNoteInputs and #802
        // AcknowledgedShortInputs after it, so a pre-v12 request now re-serialises
        // with four more trailing nulls, in order.
        const string stored = """
        ...
        Assert.Null(request.TranscriptInputs);
        Assert.Equal(stored[..^1] + ",\"MacroChoices\":null,\"TranscriptInputs\":null,\"AmbientNoteInputs\":null,\"AcknowledgedShortInputs\":null}", JsonSerializer.Serialize(request, Durable));
    }
    ...
    public void AStoredInitialize_WithoutMacroChoices_BindsNull()
    {
        ...
        Assert.EndsWith(",\"MacroChoices\":null,\"ExcludedMacros\":null,\"EngineRelease\":null,\"TerminologyServerRelease\":null,\"ResolvedInputTypes\":null,\"AcknowledgedShortInputs\":null}", current);
        var stored = current.Replace(",\"MacroChoices\":null,\"ExcludedMacros\":null,\"EngineRelease\":null,\"TerminologyServerRelease\":null,\"ResolvedInputTypes\":null,\"AcknowledgedShortInputs\":null}", "}", StringComparison.Ordinal);
