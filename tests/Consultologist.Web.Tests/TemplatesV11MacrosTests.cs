...
public class TemplatesV11MacrosTests : ClientRenderTestContext
{
    ...
    public void BelowEleven_TheCarriedShapes_AreRefusedByName()
    {
        ...
        Assert.Contains("macros requires specVersion 11. Use \"Upgrade to specVersion 15\" and publish.", refusals);
        Assert.Contains("Result 'consult_note' declares macros, which requires specVersion 11. Use \"Upgrade to specVersion 15\" and publish.", refusals);
        Assert.Contains("Result 'consult_note' declares signature, which requires specVersion 11. Use \"Upgrade to specVersion 15\" and publish.", refusals);
        Assert.Contains("Node 'scope' declares reproducible, which requires specVersion 11. Use \"Upgrade to specVersion 15\" and publish.", refusals);
        Assert.Null(sent);
    }
