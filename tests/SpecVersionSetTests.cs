...
public class SpecVersionSetTests
{
    ...
    public void TheRefusalSentence_StillReadsAsASentence()
    {
        ...
        Assert.Equal("5, 6, 7, 8, 9, 10, 11, 12, 13 or 14", WorkflowPackageValidator.DescribeAcceptedSpecVersions());
    }
    ...
    public void TheTwoRefusals_AreAllowedToWordItDifferently()
    {
        ...
        Assert.Contains("5 or 6 or 7 or 8 or 9 or 10 or 11 or 12 or 13 or 14", store.Message);
