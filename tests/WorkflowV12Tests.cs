...
public class WorkflowV12GateTests
{
    ...
    {
        // 19 is accepted since #845; the version after it is what the set refuses.
        Assert.Contains(V12Fixtures.Validate(V12Fixtures.Minimal() with { SpecVersion = 20 }).Errors,
