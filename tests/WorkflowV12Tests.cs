...
public class WorkflowV12GateTests
{
    ...
    {
        // 18 is accepted since #822; the version after it is what the set refuses.
        Assert.Contains(V12Fixtures.Validate(V12Fixtures.Minimal() with { SpecVersion = 19 }).Errors,
