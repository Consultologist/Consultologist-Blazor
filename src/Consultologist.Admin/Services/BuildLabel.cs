namespace Consultologist.Admin.Services;

/// <summary>
/// #412/#733: the client's build, read from <c>Build:Commit</c> in
/// appsettings.json. The admin SWA workflow stamps the commit there before Oryx
/// publishes; a build without it (local, or a publish outside that workflow)
/// says so rather than showing nothing. Mirrors the clinician app's BuildLabel.
/// </summary>
