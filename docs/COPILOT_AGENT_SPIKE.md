...
`docs/DRAGON_COPILOT_SPIKE.md` (fit gate resolved 2026-09-10 — the direct extension is
**deferred**; the payload carries no referral and no clinician token, so EHR-mediated is
recommended). **This** is us building and
