...
| `Operators__AppUserIds` | Comma/space-separated AppUserIds allowed to call operator surfaces (`GET /api/Operator/PinHealth`, #384; `GET /api/Operator/Usage` and the /operators panel, #553). Not a role: an ordinary account, listed here. Matched exactly | nobody | no |
